...
WSE_SKETCHES_REVISION="d23383dbaaf57c4c2cd234ef9479ae8ac4604c5f"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-09-17/lex11b-l+async-ga-hypermutator-512"
...
for config in \
    ...
    "export ASYNC_GA_NCOL_SUBGRID=9 ASYNC_GA_NROW_SUBGRID=9 NREP=1 ASYNC_GA_NCYCLE_AT_LEAST=50000" \
    ...
    "export ASYNC_GA_NCOL_SUBGRID=729 ASYNC_GA_NROW_SUBGRID=729 NREP=9 ASYNC_GA_NCYCLE_AT_LEAST=500000" \
    "export ASYNC_GA_NCOL_SUBGRID=0 ASYNC_GA_NROW_SUBGRID=0 NREP=9 ASYNC_GA_NCOL=750 ASYNC_GA_NROW=994 ASYNC_GA_NCYCLE_AT_LEAST=500000" \
; do
eval "${config}"
echo "ASYNC_GA_NCOL ${ASYNC_GA_NCOL}"
echo "ASYNC_GA_NROW ${ASYNC_GA_NROW}"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_capped2xl_denovo"
