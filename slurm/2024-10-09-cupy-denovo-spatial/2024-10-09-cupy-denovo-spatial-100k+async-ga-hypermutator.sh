...
WSE_SKETCHES_REVISION="56fe4d77bad897da110af00ed89c4e7d58b938ce"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-10-09-cupy-denovo-spatial-100k/nben=${NBEN}+async-ga-hypermutator-512"
...
seed=0
export ASYNC_GA_NCOL=827
echo "ASYNC_GA_NCOL ${ASYNC_GA_NCOL}"

export ASYNC_GA_NROW=827
echo "ASYNC_GA_NROW ${ASYNC_GA_NROW}"

for config in \
    "export ASYNC_GA_NCOL_SUBGRID=827 ASYNC_GA_NROW_SUBGRID=827 NREP=9" \
; do
eval "${config}"
echo "ASYNC_GA_NCOL ${ASYNC_GA_NCOL}"
echo "ASYNC_GA_NROW ${ASYNC_GA_NROW}"
