...
WSE_SKETCHES_REVISION="11cdc887946f95494e95632991eab39873fb4472"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-09-01b-xl/lex11+async-ga-hypermutator-512"
...
for config in \
    "export ASYNC_GA_NCOL_SUBGRID=1 ASYNC_GA_NROW_SUBGRID=1 NREP=1 ASYNC_GA_NCYCLE_AT_LEAST=500000" \
    "export ASYNC_GA_NCOL_SUBGRID=3 ASYNC_GA_NROW_SUBGRID=3 NREP=1 ASYNC_GA_NCYCLE_AT_LEAST=50000" \
    "export ASYNC_GA_NCOL_SUBGRID=9 ASYNC_GA_NROW_SUBGRID=8 NREP=1 ASYNC_GA_NCYCLE_AT_LEAST=50000" \
    "export ASYNC_GA_NCOL_SUBGRID=27 ASYNC_GA_NROW_SUBGRID=27 NREP=1 ASYNC_GA_NCYCLE_AT_LEAST=50000" \
    "export ASYNC_GA_NCOL_SUBGRID=81 ASYNC_GA_NROW_SUBGRID=81 NREP=1 ASYNC_GA_NCYCLE_AT_LEAST=50000" \
    "export ASYNC_GA_NCOL_SUBGRID=243 ASYNC_GA_NROW_SUBGRID=243 NREP=1 ASYNC_GA_NCYCLE_AT_LEAST=500000" \
    "export ASYNC_GA_NCOL_SUBGRID=729 ASYNC_GA_NROW_SUBGRID=729 NREP=3 ASYNC_GA_NCYCLE_AT_LEAST=500000" \
    "export ASYNC_GA_NCOL_SUBGRID=0 ASYNC_GA_NROW_SUBGRID=0 NREP=3 ASYNC_GA_NCOL=750 ASYNC_GA_NROW=994 ASYNC_GA_NCYCLE_AT_LEAST=500000" \
; do
eval "${config}"
echo "ASYNC_GA_NCOL ${ASYNC_GA_NCOL}"
echo "ASYNC_GA_NROW ${ASYNC_GA_NROW}"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_capped2xl"
