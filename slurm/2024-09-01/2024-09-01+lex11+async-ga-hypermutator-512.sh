...
WSE_SKETCHES_REVISION="a00888d766a513629a6fa6f2db18c559a7d0b2d4"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/2024-09-01/lex11+async-ga-hypermutator-512"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_capped"
