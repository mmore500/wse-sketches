...
WSE_SKETCHES_REVISION="fcc21703ee86a4dfc21b42a818e03b17623f7f78"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-09-01d-xl/lex11+async-ga-hypermutator-512"
...
for config in \
    ...
    "export ASYNC_GA_NCOL_SUBGRID=256 ASYNC_GA_NROW_SUBGRID=256 NREP=4" \
    "export ASYNC_GA_NCOL_SUBGRID=512 ASYNC_GA_NROW_SUBGRID=512 NREP=16" \
    "export ASYNC_GA_NCOL_SUBGRID=0 ASYNC_GA_NROW_SUBGRID=0 NREP=16 ASYNC_GA_NCOL=753 ASYNC_GA_NROW=995" \
; do
eval "${config}"
echo "ASYNC_GA_NCOL ${ASYNC_GA_NCOL}"
echo "ASYNC_GA_NROW ${ASYNC_GA_NROW}"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_capped4xl"
