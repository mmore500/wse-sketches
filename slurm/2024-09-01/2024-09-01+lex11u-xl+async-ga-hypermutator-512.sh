...
WSE_SKETCHES_REVISION="6c393b51489f6d93eaa133c117134fb9efc7d4da"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-09-01u-xl/lex11+async-ga-hypermutator-512"
...
for config in \
    ...
    "export ASYNC_GA_NCOL_SUBGRID=729 ASYNC_GA_NROW_SUBGRID=729 NREP=3" \
    "export ASYNC_GA_NCOL_SUBGRID=0 ASYNC_GA_NROW_SUBGRID=0 NREP=3 ASYNC_GA_NCOL=750 ASYNC_GA_NROW=994" \
; do
eval "${config}"
echo "ASYNC_GA_NCOL ${ASYNC_GA_NCOL}"
echo "ASYNC_GA_NROW ${ASYNC_GA_NROW}"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_capped1000xl"
