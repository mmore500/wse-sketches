...
WSE_SKETCHES_REVISION="a275d33890a66779935ee03b8fef28d3beb72008"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-08-29-xl-neutral/lex10-xl+async-ga-hypermutator-512"
...
for config in \
    ...
    "export ASYNC_GA_NCOL_SUBGRID=9 ASYNC_GA_NROW_SUBGRID=8 NREP=1" \
    "export ASYNC_GA_NCOL_SUBGRID=81 ASYNC_GA_NROW_SUBGRID=81 NREP=1" \
    "export ASYNC_GA_NCOL_SUBGRID=729 ASYNC_GA_NROW_SUBGRID=729 NREP=2" \
    "export ASYNC_GA_NCOL_SUBGRID=0 ASYNC_GA_NROW_SUBGRID=0 NREP=2 ASYNC_GA_NCOL=750 ASYNC_GA_NROW=994" \
; do
eval "${config}"
echo "ASYNC_GA_NCOL ${ASYNC_GA_NCOL}"
echo "ASYNC_GA_NROW ${ASYNC_GA_NROW}"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_xl"
...
export ASYNC_GA_TOURNSIZE_NUMERATOR=10
