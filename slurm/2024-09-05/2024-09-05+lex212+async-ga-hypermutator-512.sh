...
WORKDIR="${HOME}/scratch/2024-09-05-denovo-Ub-strongsel-severemut/lex212+async-ga-hypermutator-512"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_denovo_Ub_severe"
