...
WSE_SKETCHES_REVISION="f60c78a8fc6b6f31d039b63759f1d2a3797dc3e7"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-09-05-denovo-Ud-strongsel-severemut/lex211+async-ga-hypermutator-512"
...
for config in \
    ...
    "export ASYNC_GA_NCOL_SUBGRID=256 ASYNC_GA_NROW_SUBGRID=256 NREP=2" \
    "export ASYNC_GA_NCOL_SUBGRID=512 ASYNC_GA_NROW_SUBGRID=512 NREP=8" \
; do
eval "${config}"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_denovo_Ud_severe"
...
export ASYNC_GA_TOURNSIZE_NUMERATOR=20
