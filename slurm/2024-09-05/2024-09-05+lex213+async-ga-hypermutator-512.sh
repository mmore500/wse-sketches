...
WORKDIR="${HOME}/scratch/2024-09-05-denovo-Ur-strongsel-severemut/lex213+async-ga-hypermutator-512"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_denovo_Ur_severe"
