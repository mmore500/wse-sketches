...
WSE_SKETCHES_REVISION="dd4a01244fae2c8ff96c37d4d646bffe0314fe74"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-09-23-cupy/nben=${NBEN}+async-ga-hypermutator-512"
...
for config in \
    ...
    "export ASYNC_GA_NCOL=243 ASYNC_GA_NROW=243 ASYNC_GA_NCOL_SUBGRID=243 ASYNC_GA_NROW_SUBGRID=243 NREP=9" \
; do
eval "${config}"
echo "ASYNC_GA_NCOL ${ASYNC_GA_NCOL}"
echo "ASYNC_GA_NROW ${ASYNC_GA_NROW}"
