...
WORKDIR="${HOME}/scratch/2024-09-04-denovo-Ub-strongsel-mildmut/lex19+async-ga-hypermutator-512"
...
export ASYNC_GA_GENOME_FLAVOR="genome_hypermutator_denovo_Ub_mild"
