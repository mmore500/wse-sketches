...
WSE_SKETCHES_REVISION="7c236067ae3f014402867743f230bbe7dc4b5635"
echo "WSE_SKETCHES_REVISION ${WSE_SKETCHES_REVISION}"

WORKDIR="${HOME}/scratch/2024-09-06-staggered-Ub-mild-strongsel/lex215+async-ga-hypermutator-512"
